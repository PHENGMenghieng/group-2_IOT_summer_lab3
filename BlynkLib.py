...
print("""
  ...
  / _  / / // / _ \\/ '_/
 /____/_/\\_, /_//_/_/\\_\\
        /___/ for Python v""" + __version + " (" + sys.platform + ")\n")
...
class BlynkProtocol(EventEmitter):
    def init(self, auth, tmpl_id=None, fw_ver=None, heartbeat=50, buffin=1024, log=None):
            ...
            if cmd == MSG_RSP:
                ...
                if self.state == CONNECTING and i == 1:
                    if dlen == STA_SUCCESS:
                        ...
                        info = ['ver', version, 'h-beat', self.heartbeat//1000,
                                'buff-in', self.buffin, 'dev', sys.platform+'-py']
                        if self.tmpl_id:
